...
import static by.brstu.dmitry.garbagecollector.application.InternetConnectionState.ConnectionType.CONNECTING_TO_NETWORK;
import static by.brstu.dmitry.garbagecollector.application.InternetConnectionState.ConnectionType.CONNECTING_TO_ROBOT;
import static by.brstu.dmitry.garbagecollector.application.InternetConnectionState.ConnectionType.NETWORK_DISCONNECTING;
...
public class InternetConnectionState {
    ...
    public @interface ConnectionType {
        ...
        int NETWORK_DISCONNECTING = R.string.network_is_disconnecting;

        int CONNECTING_TO_ROBOT = R.string.connecting_to_robot;
        int CONNECTING_TO_NETWORK = R.string.connecting_to_network;
